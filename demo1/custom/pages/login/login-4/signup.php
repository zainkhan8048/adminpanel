...
<head>
	...
	<meta charset="utf-8" />
	<title>Sign Up | technagers</title>
							...
							<form class="form px-10" novalidate="novalidate" id="kt_login_signup_form">
								...
								<div class="" data-wizard-type="step-content" data-wizard-state="current">
									...
									<div class="pb-10 pb-lg-12">
										...
										<a href="signin.php" class="text-primary font-weight-bolder">Sign In</a></div>
									</div>
									<!--begin::Title-->
									<!--begin::Form Group-->
									<div class="form-group">
										<label name="user_category_id" class="font-size-h6 font-weight-bolder text-dark">Select Category</label>
										<!--begin::Select-->
										<div class="form-group">
											<select name="user_category_id" class="form-control form-control-solid h-auto py-7 px-5 border-0 rounded-lg font-size-h6">
												<option value="">Select</option>
												<?php
												$stmt = $conn->prepare("SELECT user_category_id, user_category_name, user_category_type FROM user_category");
												$stmt->execute();
									...
									<div class="form-group">
										...
										<input type="text" class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="user_first_name" placeholder="First Name" value="" />
									</div>
									<!--end::Form Group-->
									<!--begin::Form Group-->
									<div class="form-group">
										<label class="font-size-h6 font-weight-bolder text-dark">Last Name</label>
										<input type="text" class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="user_last_name" placeholder="Last Name" value="" />
									</div>
									<!--end::Form Group-->
									<!--begin::Form Group-->
									<div class="form-group">
										<label class="font-size-h6 font-weight-bolder text-dark">Gender</label>
										<select name="user_gender" class="form-control form-control-solid h-auto py-7 px-5 border-0 rounded-lg font-size-h6">
								...
								<!--begin::Form Group-->
								<div class="form-group">
										<label class="font-size-h6 font-weight-bolder text-dark">NIC</label>
										<input type="number" class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="user_nic" placeholder="NIC Number" value="" />
									</div>
									...
									<div class="row">
										<div class="col-xl-6">
											...
											<div class="form-group">
												...
												<input type="text" class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="user_address" placeholder="Address Line 1" value="Address Line 1" />
										...
										<div class="col-xl-6">
											...
											<div class="form-group">
												...
												<input type="text" class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="user_address" placeholder="Address Line 2" value="Address Line 2" />
												<span class="form-text text-muted">Please enter your Address.</span>
											</div>
											<!--end::Input-->
										</div>
