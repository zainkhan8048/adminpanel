...
<head>
		...
		<meta charset="utf-8" />
		<title>Live preview | Technagers</title>
		<meta name="description" content="In house System." />
		...
		<link href="../theme/html/demo1/dist/assets/plugins/custom/fullcalendar/fullcalendar.bundleafa4.css?v=7.2.0" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-row flex-column-fluid page">
				...
				<!--end::Aside-->
				<!--begin::Wrapper-->
				<?php include('include/wrapper-dashboard.php'); ?>
